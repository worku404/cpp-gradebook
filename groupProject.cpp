...
int findStudentById(const char ids[][ID_LEN], const char* id, int studentCount);
...
void printStudentReport(const char ids[][ID_LEN], 
    const char names[][NAME_LEN], 
    const double marks[][MAX_TESTS], 
    int studentCount, 
    int testCount);
void listStudents( const char ids[][ID_LEN], 
    const char names[][NAME_LEN], 
    const double marks[][MAX_TESTS], 
    int studentCount, 
    int testCount);
